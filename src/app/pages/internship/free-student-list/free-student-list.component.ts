...
@Component({
  selector: 'app-free-student-list',
  templateUrl: './free-student-list.component.html',
  styleUrl: './free-student-list.component.scss'
})
export class FreeStudentListComponent {
